...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateMonthAndYearHeader = function generateMonthAndYearHeader(prevButton, nextButton, preventMobile) {
      ...
      if (isMobile) {
        ...
        return [
          '<div class="_Otelika-datepicker-calendar-header">',
            '<div class="_Otelika-datepicker-calendar-header-middle _Otelika-datepicker-mobile-item _Otelika-datepicker-calendar-month">',
      ...
      return [
        '<div class="_Otelika-datepicker-calendar-header">',
          '<div class="_Otelika-datepicker-calendar-header-left">',
            '<a class="_Otelika-datepicker-calendar-month-button" href="javascript:void(0)" ng-class="{\'_Otelika-datepicker-item-hidden\': !willPrevMonthBeSelectable()}" ng-click="prevMonth()" title="{{ buttonPrevTitle }}">',
              prevButton,
            '</a>',
          '</div>',
          '<div class="_Otelika-datepicker-calendar-header-middle _Otelika-datepicker-calendar-month">',
            '{{month}}&nbsp;',
            '<a href="javascript:void(0)" ng-click="paginateYears(year); showYearsPagination = !showYearsPagination;">',
              '<span>',
                '{{year}}',
                '<i ng-class="{\'_Otelika-datepicker-calendar-header-closed-pagination\': !showYearsPagination, \'_Otelika-datepicker-calendar-header-opened-pagination\': showYearsPagination}"></i>',
              '</span>',
            '</a>',
          '</div>',
          '<div class="_Otelika-datepicker-calendar-header-right">',
          '<a class="_Otelika-datepicker-calendar-month-button" ng-class="{\'_Otelika-datepicker-item-hidden\': !willNextMonthBeSelectable()}" href="javascript:void(0)" ng-click="nextMonth()" title="{{ buttonNextTitle }}">',
            nextButton,
          '</a>',
          '</div>',
        '</div>'
    ...
    , generateYearsPaginationHeader = function generateYearsPaginationHeader(prevButton, nextButton) {
      ...
      return [
        '<div class="_Otelika-datepicker-calendar-header" ng-show="showYearsPagination">',
          '<div class="_Otelika-datepicker-calendar-years-pagination">',
            '<a ng-class="{\'_Otelika-datepicker-active\': y === year, \'_Otelika-datepicker-disabled\': !isSelectableMaxYear(y) || !isSelectableMinYear(y)}" href="javascript:void(0)" ng-click="setNewYear(y)" ng-repeat="y in paginationYears track by $index">',
              '{{y}}',
            '</a>',
          '</div>',
          '<div class="_Otelika-datepicker-calendar-years-pagination-pages">',
            '<a href="javascript:void(0)" ng-click="paginateYears(paginationYears[0])" ng-class="{\'_Otelika-datepicker-item-hidden\': paginationYearsPrevDisabled}">',
              prevButton,
            '</a>',
            '<a href="javascript:void(0)" ng-click="paginateYears(paginationYears[paginationYears.length -1 ])" ng-class="{\'_Otelika-datepicker-item-hidden\': paginationYearsNextDisabled}">',
              nextButton,
            '</a>',
          '</div>',
        '</div>'
    ...
    , generateDaysColumns = function generateDaysColumns() {
      ...
      return [
      '<div class="_Otelika-datepicker-calendar-days-header">',
    ...
    , generateDays = function generateDays() {
      ...
      return [
        '<div class="_Otelika-datepicker-calendar-body">',
          '<a href="javascript:void(0)" ng-repeat="px in prevMonthDays" class="_Otelika-datepicker-calendar-day _Otelika-datepicker-disabled">',
            '{{px}}',
          '</a>',
          '<a href="javascript:void(0)" ng-repeat="item in days" ng-click="setDatepickerDay(item)" ng-class="{\'_Otelika-datepicker-active\': selectedDay === item && selectedMonth === monthNumber && selectedYear === year, \'_Otelika-datepicker-disabled\': !isSelectableMinDate(year + \'/\' + monthNumber + \'/\' + item ) || !isSelectableMaxDate(year + \'/\' + monthNumber + \'/\' + item) || !isSelectableDate(monthNumber, year, item) || !isSelectableDay(monthNumber, year, item),\'_Otelika-datepicker-today\': item === today.getDate() && monthNumber === (today.getMonth() + 1) && year === today.getFullYear() && !selectedDay}" class="_Otelika-datepicker-calendar-day">',
            '{{item}}',
          '</a>',
          '<a href="javascript:void(0)" ng-repeat="nx in nextMonthDays" class="_Otelika-datepicker-calendar-day _Otelika-datepicker-disabled">',
            '{{nx}}',
          '</a>',
        '</div>'
      ];
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton, preventMobile) {
      ...
      var toReturn = [
        '<div class="_Otelika-datepicker-calendar {{datepickerClass}} {{datepickerID}}" ng-class="{\'_Otelika-datepicker-forced-to-open\': checkVisibility()}" ng-blur="hideCalendar()">',
        '</div>'
      ]
    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate, $timeout) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , theCalendar
          , defaultPrevButton = '<b class="_Otelika-datepicker-default-button">&lang;</b>'
          , defaultNextButton = '<b class="_Otelika-datepicker-default-button">&rang;</b>'
          ...
          , showCalendar = function showCalendar() {
            ...
            pageDatepickers = $window.document.getElementsByClassName('_Otelika-datepicker-calendar');

            angular.forEach(pageDatepickers, function forEachDatepickerPages(value, key) {
              if (pageDatepickers[key].classList) {

                pageDatepickers[key].classList.remove('_Otelika-datepicker-open');
              } else {

                classHelper.remove(pageDatepickers[key], '_Otelika-datepicker-open');
              }
            });

            if (theCalendar.classList) {

              theCalendar.classList.add('_Otelika-datepicker-open');
              if (dateFormat) {
              ...
              classHelper.add(theCalendar, '_Otelika-datepicker-open');
            }
        ...
        $scope.hideCalendar = function hideCalendar() {
          if (theCalendar.classList) {
            theCalendar.classList.remove('_Otelika-datepicker-open');
          } else {

            classHelper.remove(theCalendar, '_Otelika-datepicker-open');
          }
        };
        ...
        if ($scope.datepickerAppendTo &&
          ...
          theCalendar = element[0].querySelector('._Otelika-datepicker-calendar');
        }
  ...
  angular.module('Otelika.datepicker', [])
